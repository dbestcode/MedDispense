...
::===================================================================================
cls
if exist "data\students[Conflict].csv" (
   type "data\students[Conflict].csv">data\tempstudents.file
   del /s "data\students[Conflict].csv"
) else (
...
::===================================================================================
cls
if exist "data\students[Conflict 1].csv" (
   type "data\students[Conflict 1].csv">data\tempstudents.file
   del /s "data\students[Conflict 1].csv"
) else (
	echo xxx,xxx,xxx,xxx>data\tempstudents.file
)
...
::===================================================================================
cls
if exist "data\students[Conflict 3].csv" (
   type "data\students[Conflict 2].csv">data\tempstudents.file
   del /s "data\students[Conflict 2].csv"
) else (
	echo xxx,xxx,xxx,xxx>data\tempstudents.file
) 
